...
if (os.path.exists("linux_share/test_13/whatsLeft.txt") == False):
    with open('linux_share/test_13/failList.txt', 'r') as firstfile, open('linux_share/test_13/whatsLeft.txt', 'w') as secondfile:
        for line in firstfile:
            secondfile.write(line)

# Load the (existing) working list.

f = open('linux_share/test_13/whatsLeft.txt', 'r')
...
with open('linux_share/test_13/whatsLeft.txt', 'w') as outfile:
...
if (os.path.exists('linux_share/test_13/progress.txt') == False):
    with open('linux_share/test_13/progress.txt', 'w') as outfile:
        outfile.write("Preparing to compare Turaev-Viro invariants of DBC's and surgeries for the given knots.")

f = open('linux_share/test_13/progress.txt', 'r')
...
for k in range(0,len(knotList)):
    ...
    for q in qList[k]:
        ...
        if (tvSurgery == tvCover):
            ...
            with open('linux_share/test_13/progress.txt', 'a') as outfile:
                outfile.write("\n")
                outfile.write(temp)
            fail = 1
