...
f = open("linux_share/test_13/numDTList.txt", "r")
...
#with open("/home/sage/linux_share/test_13/alexList.txt", "w") as outfile:
#    outfile.write("\n".join(alexList))

with open("/home/sage/linux_share/test_13/detList.txt", "w") as outfile:
    outfile.write("\n".join(detList))

with open("/home/sage/linux_share/test_13/aList.txt", "w") as outfile:
    outfile.write("\n".join(aList))
...
with open('/home/sage/linux_share/test_13/jonesList.txt','w') as outfile: 
    outfile.write('\n'.join(jonesListString))

with open('/home/sage/linux_share/test_13/sigList.txt','w') as outfile: 
    outfile.write('\n'.join(sigListString))
...
with open('/home/sage/linux_share/test_13/cassonList.txt','w') as outfile: 
