...
f = open("linux_share/test_14/numDTList.txt", "r")
...
#with open("/home/sage/linux_share/test_14/alexList.txt", "w") as outfile:
#    outfile.write("\n".join(alexList))

with open("/home/sage/linux_share/test_14/detList.txt", "w") as outfile:
    outfile.write("\n".join(detList))

with open("/home/sage/linux_share/test_14/aList.txt", "w") as outfile:
    outfile.write("\n".join(aList))
...
with open('/home/sage/linux_share/test_14/jonesList.txt','w') as outfile: 
    outfile.write('\n'.join(jonesListString))

with open('/home/sage/linux_share/test_14/sigList.txt','w') as outfile: 
    outfile.write('\n'.join(sigListString))
...
with open('/home/sage/linux_share/test_14/cassonList.txt','w') as outfile: 
